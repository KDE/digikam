...
#ifndef DIGIKAM_BCGCORRECTION_PLUGIN_H
#define DIGIKAM_BCGCORRECTION_PLUGIN_H
...
public:
    ...
    explicit BCGCorrectionPlugin(QObject* const parent = 0);
    ~BCGCorrectionPlugin();
...
#endif // DIGIKAM_BCGCORRECTION_PLUGIN_H
