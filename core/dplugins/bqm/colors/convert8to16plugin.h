...
#ifndef DIGIKAM_CONVERT8TO16_PLUGIN_H
#define DIGIKAM_CONVERT8TO16_PLUGIN_H
...
public:
    ...
    explicit Convert8To16Plugin(QObject* const parent = 0);
    ~Convert8To16Plugin();
...
#endif // DIGIKAM_CONVERT8TO16_PLUGIN_H
