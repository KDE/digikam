...
#define DPLUGIN_IID "org.kde.digikam.GeolocationEdit"

namespace Digikam
{

class GeolocationEditPlugin : public DPlugin
{
    Q_OBJECT
...
public:
    ...
    explicit GeolocationEditPlugin(QObject* const parent = 0);
    ~GeolocationEditPlugin();
