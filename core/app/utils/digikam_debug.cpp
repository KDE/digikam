...
Q_LOGGING_CATEGORY(DIGIKAM_DPLUGIN_GENERIC_LOG, "digikam.dplugin.generic")
Q_LOGGING_CATEGORY(DIGIKAM_DPLUGIN_EDITOR_LOG,  "digikam.dplugin.editor")
Q_LOGGING_CATEGORY(DIGIKAM_DPLUGIN_BQM_LOG,     "digikam.dplugin.bqm")
