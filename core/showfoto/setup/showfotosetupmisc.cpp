      ...
      d(new Private)
{
    ...
    d->showSplash       = new QCheckBox(i18n("&Show splash screen at startup"),            apparencePanel);
    d->nativeFileDialog = new QCheckBox(i18n("Use native file dialogs from the system"),   apparencePanel);
