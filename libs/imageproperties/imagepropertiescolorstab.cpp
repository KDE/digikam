                        ...
                        : NavigateBarTab(parent)
{
    ...
    Q3GridLayout *topLayout = new Q3GridLayout(histogramPage, 8, 3, 
    ...
    d->scaleBG = new Q3HButtonGroup(histogramPage);
    ...
    d->regionBG = new Q3HButtonGroup(histogramPage);
