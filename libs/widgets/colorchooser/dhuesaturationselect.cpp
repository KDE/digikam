...
{
public:
    Private(DHueSaturationSelector *q): q(q) {}
...
DHueSaturationSelector::DHueSaturationSelector( QWidget *parent )
...
void DHueSaturationSelector::setColorValue( int colorValue )
{
