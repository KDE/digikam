...
public:
    ...
    explicit LensDistortionFilter(QObject* parent = 0);
    explicit LensDistortionFilter(DImg* orgImage, QObject* parent=0, double main=0.0,
    ...
    static QString          DisplayableName()   { return I18N_NOOP("Lens Distortion Tool"); }
