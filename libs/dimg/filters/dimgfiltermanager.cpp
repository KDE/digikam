...
void DImgFilterManager::Private::setupFilterIcons()
{
    ...
    filterIcons.insert(QLatin1String("digikam:DistortionFXFilter"),   QLatin1String("distortionfx"));
    ...
    filterIcons.insert(QLatin1String("digikam:FreeRotationFilter"),   QLatin1String("freerotation"));
    ...
    filterIcons.insert(QLatin1String("digikam:InvertFilter"),         QLatin1String("invertimage"));
    ...
    filterIcons.insert(QLatin1String("digikam:RatioCrop"),            QLatin1String("ratiocrop"));
    ...
    filterIcons.insert(QLatin1String("digikam:RawConverter"),         QLatin1String("kdcraw"));
}
