...
class DIGIKAM_EXPORT LASettings : public QWidget
{
    Q_OBJECT

public:

    explicit LASettings(QWidget* const parent);
    ~LASettings();

    LAContainer defaultSettings() const;
    void resetToDefault();

    LAContainer settings() const;
    void setSettings(const LAContainer& settings);
