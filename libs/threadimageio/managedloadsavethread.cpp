...
void ManagedLoadSaveThread::load(LoadingDescription description, LoadingMode loadingMode, LoadingPolicy policy, AccessMode accessMode)
{
    ...
    //kDebug(digiKamAreaCode) << "ManagedLoadSaveThread::load " << description.filePath << ", policy " << policy;
    switch(policy)
    {
        case LoadingPolicyFirstRemovePrevious:
            ...
            //kDebug(digiKamAreaCode) << "LoadingPolicyFirstRemovePrevious, Existing task " << existingTask <<
            ...
            for (int i=0; i < m_todo.size(); ++i)
            {
                ...
                {
                    //kDebug(digiKamAreaCode) << "Removing task " << task << " from list";
        ...
        case LoadingPolicyPrepend:
            ...
            //kDebug(digiKamAreaCode) << "LoadingPolicyPrepend, Existing task " << existingTask << ", m_currentTask " << m_currentTask;
        ...
        case LoadingPolicyAppend:
            ...
            if (existingTask)
                break;
            //kDebug(digiKamAreaCode) << "LoadingPolicyAppend, Existing task " << existingTask << ", m_currentTask " << m_currentTask;
        ...
        case LoadingPolicyPreload:
            ...
            //kDebug(digiKamAreaCode) << "LoadingPolicyPreload, Existing task " << existingTask;
            if (existingTask)
                break;
...
void ManagedLoadSaveThread::loadPreview(LoadingDescription description)
{
    ...
    //kDebug(digiKamAreaCode)<<"loadPreview for " << description.filePath << " existingTask " << existingTask << " currentTask " << m_currentTask;
