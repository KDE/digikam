...
void ImageLister::listAlbum(ImageListerReceiver* const receiver,
...
void ImageLister::listAreaRange(ImageListerReceiver* const receiver,
...
void ImageLister::listSearch(ImageListerReceiver* const receiver,
                             const QString& xml,
                             int limit)
{
    if (xml.isEmpty())
