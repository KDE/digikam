...
class ImageFilterModelWorker : public QObject
{
    Q_OBJECT
...
class ImageFilterModelPreparer : public ImageFilterModelWorker
{
    Q_OBJECT
...
class ImageFilterModelFilterer : public ImageFilterModelWorker
{
    Q_OBJECT
