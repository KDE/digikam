...
public:
    ...
    pointtransformaffine(//const matrix<float,2,2>& m_,
...
template <typename T>
pointtransformaffine find_affine_transform(//const std::vector<dlib::vector<T,2> >& from_points,
...
//template <typename T>
pointtransformaffine find_similarity_transform(//const std::vector<dlib::vector<T,2> >& from_points,
