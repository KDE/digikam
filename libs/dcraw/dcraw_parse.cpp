...
/***************************************************************
                Private methods from dcraw::parse.c
 **************************************************************/

ushort DcrawParse::sget2 (uchar *s)
{
...
float DcrawParse::int_to_float (int i)
{
...
void DcrawParse::tiff_dump(int base, int tag, int type, int count, int level)
{
  int save, j, num, den;
  uchar c;
...
void DcrawParse::parse_nikon_capture_note (int length)
{
...
void DcrawParse::nikon_decrypt (uchar ci, uchar cj, int tag, int i, int size, uchar *buf)
{
...
void DcrawParse::nef_parse_makernote (int base)
{
...
void DcrawParse::nef_parse_exif(int base)
{
...
void DcrawParse::sony_decrypt (unsigned *data, int len, int start, int key)
{
...
int DcrawParse::parse_tiff_ifd (int base, int level)
{
 ...
 */
void DcrawParse::parse_tiff (int base)
{
 ...
 */
void DcrawParse::parse_ciff (int offset, int length, int level)
{
...
int DcrawParse::parse_jpeg (int offset)
{
  int len, save, hlen;
...
void DcrawParse::parse_riff (int level)
{
...
void DcrawParse::parse_mos(int level)
{
  char data[256];
  int i, skip, save;
  char *cp;
...
void DcrawParse::rollei_decode (FILE *tfp)
{
  ushort data;
  int row, col;
...
void DcrawParse::get_utf8 (int offset, char *buf, int len)
{
  ushort c;
  char *cp;
...
void DcrawParse::foveon_tree (unsigned huff[1024], unsigned code)
{
  struct decode *cur;
  int i, len;
...
void DcrawParse::foveon_decode (FILE *tfp)
{
...
void DcrawParse::kodak_yuv_decode (FILE *tfp)
{
  uchar c, blen[384];
...
void DcrawParse::parse_fuji (int offset)
{
  int entries, tag, len;
...
void DcrawParse::parse_phase_one (int base)
{
...
char *DcrawParse::memmem (char *haystack, size_t haystacklen,
...
/***************************************************************
          Publics methods inspired from dcraw::parse.c
 **************************************************************/
...
int DcrawParse::getCameraModel(const char* infile, char* cameraConstructor, char* cameraModel)
{
    char head[32], *cp;
