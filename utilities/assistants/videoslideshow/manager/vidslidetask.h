...
public:
    ...
    static DIGIKAM_EXPORT QImage makeFramedImage(const QString& file, const QSize& outSize);
    static DIGIKAM_EXPORT QImage makeScaledImage(QImage& timg, const QSize& outSize);
