    ...
    : QWidget(parent), d(new Private)
{
    ...
    d->previewOriginalButton->setIcon(QPixmap(QStandardPathsWrap::locate(QStandardPaths::GenericDataLocation, "digikam/data/original.png")));
    ...
    d->previewOriginalButton->setObjectName("preview-original");
    ...
    d->previewBothButtonVert->setIcon(QPixmap(QStandardPathsWrap::locate(QStandardPaths::GenericDataLocation, "digikam/data/bothvert.png")));
    ...
    d->previewBothButtonVert->setObjectName("preview-both-vert");
    ...
    d->previewBothButtonHorz->setIcon(QPixmap(QStandardPathsWrap::locate(QStandardPaths::GenericDataLocation, "digikam/data/bothhorz.png")));
    ...
    d->previewBothButtonHorz->setObjectName("preview--both-horz");
    ...
    d->previewDuplicateBothButtonVert->setIcon(QPixmap(QStandardPathsWrap::locate(QStandardPaths::GenericDataLocation, "digikam/data/duplicatebothvert.png")));
    ...
    d->previewDuplicateBothButtonVert->setObjectName("preview-duplicate-both-vert");
    ...
    d->previewDupplicateBothButtonHorz->setIcon(QPixmap(QStandardPathsWrap::locate(QStandardPaths::GenericDataLocation, "digikam/data/duplicatebothhorz.png")));
    ...
    d->previewDupplicateBothButtonHorz->setObjectName("preview-duplicate-both-horz");
    ...
    d->previewtargetButton->setIcon(QPixmap(QStandardPathsWrap::locate(QStandardPaths::GenericDataLocation, "digikam/data/target.png")));
    ...
    d->previewtargetButton->setObjectName("preview-target");
    ...
    d->previewToggleMouseOverButton->setIcon(QPixmap(QStandardPathsWrap::locate(QStandardPaths::GenericDataLocation, "digikam/data/togglemouseover.png")));
    ...
    d->previewToggleMouseOverButton->setObjectName("preview-toggle-mouse-over");
