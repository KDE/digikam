 ...
 *
 * @date   2009-12-08
 * @brief  Marble-backend for GeoIface
 *
...
#define GEOIFACE_MARBLE_ADD_LAYER
...
BackendMarble::BackendMarble(const QExplicitlySharedDataPointer<GeoIfaceSharedData>& sharedData, QObject* const parent)
...
void BackendMarble::mapWidgetDocked(const bool state)
{
    ...
    {
        GeoIfaceGlobalObject* const go = GeoIfaceGlobalObject::instance();
        go->updatePooledWidgetState(d->marbleWidget, state ? GeoIfaceInternalWidgetInfo::InternalWidgetStillDocked
