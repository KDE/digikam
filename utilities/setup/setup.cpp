    ...
    : KPageDialog(parent), d(new Private)
{
    ...
    d->page_collections->setIcon(QIcon::fromTheme("folder-image"));
    ...
    d->page_albumView->setIcon(QIcon::fromTheme("view-list-icons"));
    ...
    d->page_category->setIcon(QIcon::fromTheme("view-calendar-list"));
    ...
    d->page_tooltip->setIcon(QIcon::fromTheme("dialog-information"));
    ...
    d->page_metadata->setIcon(QIcon::fromTheme("exifinfo")); // krazy:exclude=iconnames
    ...
    d->page_template->setIcon(QIcon::fromTheme("user-identity"));
    ...
    d->page_mime->setIcon(QIcon::fromTheme("system-file-manager"));
    ...
    d->page_editor->setIcon(QIcon::fromTheme("editimage"));
    ...
    d->page_versioning->setIcon(QIcon::fromTheme("view-catalog"));
    ...
    d->page_icc->setIcon(QIcon::fromTheme("colormanagement"));
    ...
    d->page_lighttable->setIcon(QIcon::fromTheme("lighttable"));
    ...
    d->page_slideshow->setIcon(QIcon::fromTheme("view-presentation"));
    ...
    d->page_imagequalitysorter->setIcon(QIcon::fromTheme("flag-green"));
    ...
    d->page_camera->setIcon(QIcon::fromTheme("camera-photo"));
    ...
    d->page_misc->setIcon(QIcon::fromTheme("preferences-other"));
