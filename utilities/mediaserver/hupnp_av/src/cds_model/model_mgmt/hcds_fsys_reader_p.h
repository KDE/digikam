...
#ifndef HCDS_FILESYSTEM_READER_P_H_
#define HCDS_FILESYSTEM_READER_P_H_
...
{
H_DISABLE_COPY(HCdsFileSystemReader)
H_DECLARE_PRIVATE(HCdsFileSystemReader)

private:

    HCdsFileSystemReaderPrivate* h_ptr;
...
#endif /* HCDS_FILESYSTEM_READER_P_H_ */
