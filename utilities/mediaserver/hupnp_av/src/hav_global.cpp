...
QString toString(HDayOfWeek arg, HDayOfWeekFormat format)
{
    ...
    {
    case Monday:
        retVal = format == Full ? QLatin1String("Monday") : QLatin1String("Mon");
        break;
    case Tuesday:
        retVal = format == Full ? QLatin1String("Tuesday") : QLatin1String("Tue");
        break;
    case Wednesday:
        retVal = format == Full ? QLatin1String("Wedneday") : QLatin1String("Wed");
        break;
    case Thursday:
        retVal = format == Full ? QLatin1String("Thursday") : QLatin1String("Thu");
        break;
    case Friday:
        retVal = format == Full ? QLatin1String("Friday") : QLatin1String("Fri");
        break;
    case Saturday:
        retVal = format == Full ? QLatin1String("Saturday") : QLatin1String("Sat");
        break;
    case Sunday:
        retVal = format == Full ? QLatin1String("Sunday") : QLatin1String("Sun");
        break;
    default:
        retVal = QLatin1String("Undefined");
        break;
    }
    return retVal;
}
...
HDayOfWeek dayOfWeekFromString(const QString& arg)
{
    ...
    if (arg.startsWith(QLatin1String("mon"), Qt::CaseInsensitive))
    {
        retVal = Monday;
    }
    else if (arg.startsWith(QLatin1String("Tue"), Qt::CaseInsensitive))
    {
        retVal = Tuesday;
    }
    else if (arg.startsWith(QLatin1String("wed"), Qt::CaseInsensitive))
    {
        retVal = Wednesday;
    }
    else if (arg.startsWith(QLatin1String("thu"), Qt::CaseInsensitive))
    {
        retVal = Thursday;
    }
    else if (arg.startsWith(QLatin1String("fri"), Qt::CaseInsensitive))
    {
        retVal = Friday;
    }
    else if (arg.startsWith(QLatin1String("sat"), Qt::CaseInsensitive))
    {
        retVal = Saturday;
    }
    else if (arg.startsWith(QLatin1String("sun"), Qt::CaseInsensitive))
    {
        retVal = Sunday;
    }
    return retVal;
...
QString toString(HEpisodeType arg)
{
    ...
    {
    case EpisodeTypeAll:
        retVal = QLatin1String("ALL");
        break;
    case EpisodeTypeFirstRun:
        retVal = QLatin1String("FIRST-RUN");
        break;
    case EpisodeTypeRepeat:
        retVal = QLatin1String("REPEAT");
        break;
    default:
        break;
    }
...
HEpisodeType episodeTypeFromString(const QString& arg)
{
    ...
    else if (arg == QLatin1String("FIRST-RUN"))
    {
...
QString toString(HDaylightSaving arg)
{
    ...
    {
    case DaylightSaving:
        retVal = QLatin1String("DAYLIGHTSAVING");
        break;
    case Standard_DaylightSaving:
        retVal = QLatin1String("STANDARD");
        break;
...
HDaylightSaving daylightSavingFromString(const QString& arg)
{
    ...
    if (arg == QLatin1String("DAYLIGHTSAVING"))
    {
        retVal = DaylightSaving;
    }
    else if (arg == QLatin1String("STANDARD"))
    {
...
void addNamespaces(QXmlStreamReader& reader)
{
    QXmlStreamNamespaceDeclaration def(
        QLatin1String(""), QLatin1String("urn:schemas-upnp-org:av:avs"));
