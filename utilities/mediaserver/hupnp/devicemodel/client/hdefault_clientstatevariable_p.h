...
#ifndef HDEFAULTCLIENT_STATEVARIABLE_H_
#define HDEFAULTCLIENT_STATEVARIABLE_H_
...
class HDefaultClientStateVariable :
    public HClientStateVariable
{
H_DISABLE_COPY(HDefaultClientStateVariable)
...
#endif /* HDEFAULTCLIENT_STATEVARIABLE_H_ */
