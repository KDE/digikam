...
{
    QString srcPath = album->getFolderPath() + "/" + srcFile;
    ...
    {
        QString destPath = album->getFolderPath() + "/" + destFile;
...
void AlbumFileCopyMove::slotNext()
{
    ...
    QString srcPath = m_srcAlbum->getFolderPath() + "/" + srcFile;
    QString newDestPath;
    ...
    if (!m_overwriteAll)
    {
        while (fileStat(m_destAlbum, destFile))
        {
            ...
            QString destPath = m_destAlbum->getFolderPath() + "/" + destFile;
...
{
    QString src  = srcAlbum->getFolderPath()  + "/" + srcFile;
    QString dest = destAlbum->getFolderPath() + "/" + destFile;
...
{
    QString path = album->getFolderPath() + "/" + name;
