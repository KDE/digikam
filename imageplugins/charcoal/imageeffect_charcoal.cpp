                      ...
                      m_parent(parent)
{
    ...
    KAboutData* about = new KAboutData("charcoal", I18N_NOOP("Charcoal"), "1.0",
                                       I18N_NOOP("Charcoal drawing image effect plugin for Digikam."),
    ...
    helpMenu->menu()->insertItem(i18n("Charcoal handbook"), this, SLOT(slotHelp()), 0, -1, 0);
